...
internal class KafkaMockFactory(
        ...
        internal val pensjonsgivendeInntektConsumer: MockConsumer<HendelseKey, PensjonsgivendeInntekt> = defaultPensjonsgivendeInntektConsumer(),
) : KafkaFactory {
    override fun hendelseProducer(): Producer<HendelseKey, Hendelse> = hendelseProducer
    override fun pensjonsgivendeInntektConsumer(): Consumer<HendelseKey, PensjonsgivendeInntekt> = pensjonsgivendeInntektConsumer
    ...
    internal fun addRecord(record: ConsumerRecord<HendelseKey, PensjonsgivendeInntekt>) {
    ...
    internal fun committedOffset(): Long {
        ...
        return pensjonsgivendeInntektConsumer.committed(mutableSetOf(topicPartition), Duration.ofSeconds(2))[topicPartition]!!.offset()
    }
    ...
    companion object {
        ...
        internal fun defaultPensjonsgivendeInntektConsumer() =
                MockConsumer<HendelseKey, PensjonsgivendeInntekt>(OffsetResetStrategy.EARLIEST)
                        .apply {
